...
class MovieListVideo extends Component {
  render() {
    return (
      <div className="container-video-list">
        ...
        <div className="video-container">
          <div className="bubble-video-options">
            <div className="avance-info" style={{ backgroundImage: 'url(\'https://i.ytimg.com/vi/F_lGmkZQ-yk/maxresdefault.jpg\')',  objectFit: 'fill'}}>
